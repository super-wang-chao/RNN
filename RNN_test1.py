...
for j in range(10000):
    ...
    for position in range(binary_dim):
        ...
        synapse_1_update += np.atleast_2d(layer_1).T.dot(layer_2_delta)  # Del_p
        synapse_h_update += np.atleast_2d(prev_layer_1).T.dot(layer_1_delta)  # Del_h
        synapse_0_update += X.T.dot(layer_1_delta)  # Del_w
